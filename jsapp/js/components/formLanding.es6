...
export class FormLanding extends React.Component {
  ...
  renderHistory () {
    var dvcount = this.state.deployed_versions.count;
    return (
      <bem.FormView__row className={true || this.state.historyExpanded ? 'historyExpanded' : 'historyHidden'}>
          ...
          <bem.FormView__cell m={['columns', 'padding']}>
            ...
            <bem.FormView__cell>
              ...
              { chosenMethod == 'android' &&
                <a className="collect-link mdl-button mdl-button--colored" 
                   target="_blank" 
                   href='https://play.google.com/store/apps/details?id=org.buildamovement.whistler'>
                   {t('Download Whistler')}
                </a>
              }
            ...
            {chosenMethod == 'android' &&
              <ol>
                <li>
                  {t('Install')}
                  &nbsp;
                  <a href="https://play.google.com/store/apps/details?id=org.buildamovement.whistler" target="_blank">Whistler</a>
                  &nbsp;
  ...
  render () {
    ...
    return (
      <DocumentTitle title={`${docTitle} | Whistler`}>
        <bem.FormView m='form'>
          <bem.FormView__row>
